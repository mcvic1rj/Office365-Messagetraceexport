...
if ($MessageTraceConfig.NotifyOnStartAndEnd -eq $true){
    send-mailmessage -smtpserver mail.cmich.edu -from noreply@cmich.edu -to mcvic1rj@cmich.edu -subject "Message Trace Export Started"
}
...
if ($MessageTraceConfig.NotifyOnStartAndEnd -eq $true){
    send-mailmessage -smtpserver mail.cmich.edu -from noreply@cmich.edu -to mcvic1rj@cmich.edu -subject "Message Trace Export finished"
}
